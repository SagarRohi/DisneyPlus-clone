...
const Family=()=>{
    ...
    useEffect(()=>{
               fetch(`https://api.themoviedb.org/3/discover/movie?api_key=7a2a30724470ebf691cd1bddcb3f08ff&with_genres=10751&page=${page}`).then((data)=>{
                   return data.json();
               }).then((data)=>{
    ...
    return <div>
        ...
        <div className="bg-main">
            <p className='h-24'></p>
            <p className="uppercase mx-8  text-xl text-white font-semibold">Family</p>
